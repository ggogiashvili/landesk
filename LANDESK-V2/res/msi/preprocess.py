...
g_arpsystemcomponent = {
    ...
    "Contact": {
        "msi": "ARPCONTACT",
        "v": "https://landesk.example.com",
    },
    "HelpLink": {
        "msi": "ARPHELPLINK",
        "v": "https://landesk.example.com/support",
    },
    "ReadMe": {
        "msi": "ARPREADME",
        "v": "https://landesk.example.com",
...
def make_parser():
    ...
    parser.add_argument(
        ...
        help="The dist directory containing the .exe to install.",
    )
    parser.add_argument(
        "--arp",
        action="store_true",
    ...
    parser.add_argument(
        "--app-name", type=str, default="LANDESK", help="The app name."
    )
    parser.add_argument(
