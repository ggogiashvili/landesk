...
class MyTheme {
  ...
  // LANDESK theme: Georgian-inspired palette, refined and modern
  static const Color grayBg = Color(0xFFF2F2F5);
  static const Color accent = Color(0xFFC41E3A); // Georgian crimson
  static const Color accent50 = Color(0x77C41E3A);
  static const Color accent80 = Color(0xAAC41E3A);
  static const Color canvasColor = Color(0xFF1A1A1E);
  static const Color border = Color(0xFFD4D4D8);
  static const Color idColor = Color(0xFF0D7377); // Teal accent
  static const Color darkGray = Color.fromARGB(255, 100, 100, 108);
  static const Color cmIdColor = Color(0xFF2D6A4F);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFFC41E3A);
  static const Color hoverBorder = Color(0xFFA1A1AA);
...
List<Locale> supportedLocales = const [
  Locale('ge'), // Georgian (ქართული) - default for LANDESK
  Locale('en', 'US'),
  Locale('zh', 'CN'),
  Locale('zh', 'TW'),
  Locale('zh', 'SG'),
